...
Feature: Test IdpSektoral's Auth Endpoint
  ...
  @TCID:IDPSEKTORAL_AUTH_ENDPOINT_006
  @OpenBug
  Scenario: IdpSektoral Auth Endpoint - Negativfall - invalid TLS Client Cert
  ...
  @TCID:IDPSEKTORAL_AUTH_ENDPOINT_007
    @OpenBug
  Scenario Outline: IdpSektoral Auth Endpoint - Negativfall - invalide Entity Statements
