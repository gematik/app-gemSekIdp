...
- throw GsiException (HTTP 400) on ssl exceptions and other UnirestExceptions
- add some test identities
- update dependencies

# Release 8.1.2

- change amr for epa test identity
- change name to organization_name for AF_10100-01
- add some test identities
- verify and fix kvnr Pruefziffern of test identities
- json-summary-report is now generated by tiger instead of the serenity-maven-plugin
- add support for idToken version 2.0.0
...
- refactor session storage (from list 2 map), delete sessions after token delivery, limit session
  amount
